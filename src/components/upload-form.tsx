...
export function UploadForm() {
  ...
  return (
    <Card className="max-w-2xl mx-auto shadow-lg rounded-xl animate-slide-in">
      <CardHeader>
              ...
              {!selectedFile ? (
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="flex items-center justify-center h-10 w-10 rounded-md bg-[#F1F5F9] text-[#1E3A8A] font-medium">
