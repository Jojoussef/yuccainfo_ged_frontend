                ...
                {plans.map((plan) => (
                    <Label
                        ...
                        <RadioGroupItem
                            value={plan.id}
                            id={plan.name}
                            className='shadow-none data-[state=checked]:border-green-600 data-[state=checked]:bg-green-600 [&>svg]:data-[slot=radio-group-indicator]:*:fill-white [&>svg]:data-[slot=radio-group-indicator]:*:stroke-white'
                        />
